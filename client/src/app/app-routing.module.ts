		...
		children: [
			...
			},
			{
				...
				children: [
					{ path: '', redirectTo: 'workout-records', pathMatch: 'full' },
					{
						...
						canActivate: [AuthGuard],
						data: { title: 'Workout Records' },
					},
					{
						path: 'workout-library',
						component: WorkoutLibraryComponent,
						canActivate: [AuthGuard],
						data: { title: 'Workout Library' },
					},
					{
						path: 'exercise-library',
						component: ExerciseLibraryComponent,
						canActivate: [AuthGuard],
						data: { title: 'Exercise Library' },
					},
				],
			},
			{
			...
			},
			{
				...
				children: [
					{ path: '', redirectTo: 'meal-library', pathMatch: 'full' },
					{
						...
						canActivate: [AuthGuard],
						data: { title: 'Meal Library' },
					},
					{
						path: 'meal-plans',
						component: MealPlansComponent,
						canActivate: [AuthGuard],
						data: { title: 'Meal Plans' },
					},
				],
			},
			{
			...
			},
			{
				...
				children: [
					...
					{ path: 'strength', component: StrengthStatsComponent, canActivate: [AuthGuard], data: { title: 'Strength Stats' } },
					{ path: 'body-composition', component: BodyCompositionStatsComponent, canActivate: [AuthGuard], data: { title: 'Body Composition Stats' } },
					{ path: 'cardio', component: CardioStatsComponent, canActivate: [AuthGuard], data: { title: 'Cardio Stats' } },
				],
			},
			{
				path: 'progress',
